...
def turtle4():
    mine = rg.SimpleTurtle()
    mine.speed = 20
    mine.pen = rg.Pen('yellow', 20)
...
def turtle5():
    yuhi = rg.SimpleTurtle()
    makoto = rg.SimpleTurtle()
    yuhi.speed = 5
    makoto.speed = 50
    yuhi.pen = rg.Pen('salmon', 10)
    makoto.pen = rg.Pen('gray', 5)

    makoto.forward(20)
    makoto.left(45)
    makoto.forward(10)
    makoto.draw_circle(30)
